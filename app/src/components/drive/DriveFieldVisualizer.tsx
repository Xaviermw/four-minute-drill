import { formatClock, ordinalDown } from "../../utils/formatting";
import "./drive.css";
    ...
    <div className="field-visualizer">
      {showScoreboard && (
        <div className="scoreboard">
          ...
          <div className="sb-cell sb-togo">
            <span className="sb-label">To Go</span>
            <span className="sb-value">{fieldPosition}</span>
          </div>
          <div className="sb-cell sb-clock">
            <span className="sb-label">Clock</span>
            <span className={`sb-value sb-clock-value ${clockUrgent ? "urgent" : ""}`}>
